...
It store all the data about user information and gym workouts.

### Clickhouse

It store all the data about gym workouts and running sessions. It's used for analytics and data analysis.

### Kafka

It is used as message broker to store safely all the events generated by the test script.
Kafka stream is used to read events and to push them to Clickhouse.
