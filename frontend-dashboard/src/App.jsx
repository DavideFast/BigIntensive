...
const pages = [
  { id: "correlation", label: "Matrice correlazione" },
  { id: "status", label: "Training status" },
  { id: "volume", label: "Volumi" },
  { id: "add-single", label: "Aggiungi allenamento" },
  { id: "add-week", label: "Pianifica settimana" },
];
...
export default function App() {
  const [activePage, setActivePage] = useState("correlation");
